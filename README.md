...
local win = DiscordLib:Window("Mama hub")

local serv = win:Server("ไก่ตัน", "http://www.roblox.com/asset/?id=12235359506")


local tgls = serv:Channel("Main")

tgls:Toggle("start",false, function(value)
_G.AutoFarm = value
...
local SelectWeapona = tgls:Dropdown("Combat",WeaponList,function(value)
...
if v.Name == Mon then
   ...
   if sethiddenproperty then
    ...
    tgls:Button('Redeem All code', function()
 ...
 tgls:Toggle("White_Screen",false, function(value)
